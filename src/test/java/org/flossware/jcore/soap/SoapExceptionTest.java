...
public class SoapExceptionTest {
    ...
    public void test_default() {
        final SoapException exception = new SoapException();
    ...
    public void test_String() {
        ...
        final SoapException exception = new SoapException(msg);
    ...
    public void test_Throwable() {
        ...
        final SoapException exception = new SoapException(cause);
    ...
    public void test_String_Throwable() {
        ...
        final SoapException exception = new SoapException(msg, cause);
